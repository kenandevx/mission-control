...
echo "╚═══════════════════════════════════════════════════════╝"
echo ""
echo "  Before you can log in, fill in your Azure credentials:"
echo ""
...
echo ""
echo "  Azure portal setup (one-time):"
...
echo ""
echo "  After saving .env, restart Mission Control:"
echo -e "  ${CYAN}bash $INSTALL_DIR/scripts/mc-services.sh restart${NC}"
echo ""
